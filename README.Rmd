...
_you can check this by running `Sys.getenv("R_LIBS_USER")` in an R session and see if it returns a folder path_
...
Starting with release of GAMS 41.1.0, the standard R library for readnig `gdx` files in R using the package `gdxrrw` is deprecated.
